...
Configure MCP integration for your AI agent (e.g., Codex, Cursor, Copilot):
```bash
unity-mcp-cli setup-mcp Codex /path/to/unity/project
```
...
```bash
unity-mcp-cli setup-skills Codex /path/to/unity/project
```
